                ...
                <div className="flex-1 grid lg:grid-cols-12 gap-12 items-center mb-16">
                    ...
                    <div className="lg:col-span-5 flex justify-center lg:justify-end">
                        <div className="relative w-full max-w-md">
                            ...
                            >
                                {/* Main Bot Body */}
                                <div className="relative w-80 h-96 bg-gradient-to-br from-white/10 via-blue-500/20 to-purple-500/10 backdrop-blur-xl rounded-3xl border border-white/20 p-8 shadow-2xl hover:shadow-blue-500/30 transition-all duration-500">
                                    ...
                                    <div className="relative z-10 h-full flex flex-col justify-between">
                                        ...
                                        <div className="text-center mb-6">
                                            <div className="w-20 h-20 bg-gradient-to-r from-blue-500 to-purple-500 rounded-2xl mx-auto mb-4 flex items-center justify-center relative overflow-hidden group-hover:scale-110 transition-transform duration-300">
                                            ...
                                            <h3 className="text-2xl font-bold text-white mb-2">NexaCore AI</h3>
